...
const DEFAULT_USERS: User[] = [
  ...
  // Class 9 Daffodils
  { name: 'Aarav ashok patel', rollNumber: '01', class: '9', section: 'Daffodils' },
  { name: 'Aayush patel', rollNumber: '02', class: '9', section: 'Daffodils' },
  { name: 'Aditya Kar', rollNumber: '3', class: '9', section: 'Daffodils' },
  { name: 'Alimehdi', rollNumber: '04', class: '9', section: 'Daffodils' },
  { name: 'Ansh Bhimani', rollNumber: '05', class: '9', section: 'Daffodils' },
  { name: 'aravpatel', rollNumber: '07', class: '9', section: 'Daffodils' },
  { name: 'aryan joshi', rollNumber: '09', class: '9', section: 'Daffodils' },
  ...
  { name: 'Aniket Jadhav', rollNumber: '05', class: '9', section: 'Daisies' },
  { name: 'arnav patil', rollNumber: '06', class: '9', section: 'Daisies' },
  { name: 'Bhakti jain', rollNumber: '08', class: '9', section: 'Daisies' },
